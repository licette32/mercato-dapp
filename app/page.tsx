  ...
  return (
    <div className="flex min-h-screen flex-col overflow-x-hidden bg-background">
      ...
      <section className="relative overflow-hidden bg-background py-24 md:py-32">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_60%_40%_at_50%_0%,hsl(var(--brand-pale)/0.5),transparent)] dark:bg-[radial-gradient(ellipse_60%_40%_at_50%_0%,hsl(var(--brand-mid)/0.08),transparent)]" aria-hidden />
